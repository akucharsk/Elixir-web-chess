defmodule Chess.Accounts.User do
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email, :password, :username, :wins, :losses, :draws])
    |> validate_email(opts)
    |> validate_username(opts)
    |> validate_password(opts)
    |> validate_game_params(opts)
  end
  ...
  defp validate_game_params(changeset, _opts) do
    changeset
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Chess.Repo)
  ...
  """
  def valid_password?(%Chess.Accounts.User{hashed_password: hashed_password}, password)
