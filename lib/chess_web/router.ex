defmodule ChessWeb.Router do
  ...
  defp print_user_token(conn, _opts) do
    IO.inspect(conn.assigns, label: "User Token")
    conn
  end
  ...
  scope "/", ChessWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ChessWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ChessWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ChessWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", ChessWeb do
    ...
    live_session :current_user,
      on_mount: [{ChessWeb.UserAuth, :mount_current_user}] do
